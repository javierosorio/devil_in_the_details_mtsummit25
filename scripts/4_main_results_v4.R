...
data.binquad <- data.binquad %>%
  mutate(trans.lang = case_when(
    ...
    data_name=="BinQuad_AR_matconf" ~ "AR NST", 
    data_name=="BinQuad_AR_matconf" ~ "AR NST",                # new 
    data_name=="BinQuad_AR_matcoop" ~ "AR NST", 
    data_name=="BinQuad_AR_matcoop" ~ "AR NST",                # new 
    data_name=="BinQuad_AR_verconf" ~ "AR NST",                # new
    data_name=="BinQuad_AR_vercoop" ~ "AR NST", 
    data_name=="BinQuad_AR_vercoop" ~ "AR NST",                # new
    ...
    data_name=="BinQuad_EN_matconf" ~ "EN NST", 
    data_name=="BinQuad_EN_matcoop" ~ "EN NST", 
    data_name=="BinQuad_EN_verconf" ~ "EN NST", 
    data_name=="BinQuad_EN_vercoop" ~ "EN NST", 
    ...
    data_name=="es_binary_matconf" ~ "ES NST", 
    data_name=="es_binary_matcoop" ~ "ES NST", 
    data_name=="es_binary_verconf" ~ "ES NST", 
    data_name=="es_binary_vercoop" ~ "ES NST", 
...
data.binquad <- data.binquad %>%
  mutate(mt.tool = case_when(
    ...
    data_name=="BinQuad_AR_matconf" ~ "NST", 
    data_name=="BinQuad_AR_matconf" ~ "NST",                # new 
    data_name=="BinQuad_AR_matcoop" ~ "NST", 
    data_name=="BinQuad_AR_matcoop" ~ "NST",                # new 
    data_name=="BinQuad_AR_verconf" ~ "NST",                # new
    data_name=="BinQuad_AR_vercoop" ~ "NST", 
    data_name=="BinQuad_AR_vercoop" ~ "NST",                # new 
    ...
    data_name=="BinQuad_EN_matconf" ~ "NST", 
    data_name=="BinQuad_EN_matcoop" ~ "NST", 
    data_name=="BinQuad_EN_verconf" ~ "NST", 
    data_name=="BinQuad_EN_vercoop" ~ "NST", 
    ...
    data_name=="es_binary_matconf" ~ "NST", 
    data_name=="es_binary_matcoop" ~ "NST", 
    data_name=="es_binary_verconf" ~ "NST", 
    data_name=="es_binary_vercoop" ~ "NST", 
...
ggplot(bin.m.sd, aes(x=mt.tool, 
  ...
  geom_text(aes(label=round(f1, 2)),color="white",  size=3.5)  +
  theme_bw() +  
  xlab("") + ylab("") + 
...
ggsave("graphs/bin_results_fv.pdf", width = 4.5, height = 4, units = "in")
ggsave("graphs/bin_results_fv.png", width = 4.5, height = 4, units = "in")
...
ggplot(quad.m.sd, aes(x=mt.tool, 
   ...
   facet_grid(rows=vars(lang),cols=vars(case),scales="free") +
   theme(axis.text.x = element_text(angle=90, vjust=.5, hjust=1)) + 
  geom_text(aes(label=round(macro.f1, 2)),color="white",  size=3.5)  +
  theme_bw() + 
   xlab("") + ylab("") + 
   theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
  theme(legend.position="bottom",
        legend.justification="center",
        legend.box.spacing = unit(-13.5, "pt"),
        legend.text=element_text(size=rel(0.8))) + 
  guides(fill = guide_colourbar(theme = theme(
    legend.key.width  = unit(5, "lines"),
    legend.key.height = unit(0.5, "lines"))))
 
ggsave("graphs/quad_results_fv.pdf", width = 4.5, height = 4, units = "in")
ggsave("graphs/quad_results_fv.png", width = 4.5, height = 4, units = "in")
...
plot.matconf <- ggplot(binquad.m.sd.matconf, aes(x=mt.tool, 
  ...
  scale_fill_gradientn(limits = c(0.77,0.92),colours=colors) +   
  facet_grid(rows=vars(lang),cols=vars(case),scales="free") +
  theme(axis.text.x = element_text(angle=90, vjust=.5, hjust=1)) + 
  geom_text(aes(label=round(f1, 2)),color="white",  size=3.5)  +
  theme_bw() + 
...
ggsave("graphs/binquad_matconf_results.pdf", width = 4.5, height = 3.3, units = "in")
ggsave("graphs/binquad_matconf_results.png", width = 4.5, height = 3.3, units = "in")
...
ggsave("graphs/binquad_matcoop_results.pdf", width = 4.5, height = 3.3, units = "in")
ggsave("graphs/binquad_matcoop_results.png", width = 4.5, height = 3.3, units = "in")
...
ggsave("graphs/binquad_verbconf_results.pdf", width = 4.5, height = 3.3, units = "in")
ggsave("graphs/binquad_verbconf_results.png", width = 4.5, height = 3.3, units = "in")
...
ggsave("graphs/binquad_all_results.pdf", width = 5, height = 13, units = "in")
ggsave("graphs/binquad_all_results.png", width = 5, height = 13, units = "in")
...
bin.ar.NST <- max.bin.ar %>% 
  filter(trans.lang=="AR NST") %>% 
  filter(mt.tool=="NST") %>% 
  filter(case=="Uncased") %>%
  ungroup() %>%
  select(f1, sd)
...
# T-test
bin.ar.ttest <-tsum.test(# x = NST
  mean.x=as.numeric(bin.ar.top[1]),
  s.x   =as.numeric(bin.ar.top[2]),n.x=50,
  # y = trans
  mean.y=as.numeric(bin.ar.NST[1]),
  s.y   =as.numeric(bin.ar.NST[2]),n.y=50)

bin.ar.ttest

# OPUS > NST Statistically significant at p<0.000
...
bin.en.NST <- max.bin.en %>% 
  filter(trans.lang=="EN NST") %>% 
  filter(mt.tool=="NST") %>% 
  filter(case=="Cased") %>%
  ungroup() %>%
  select(f1, sd)
...
# T-test
bin.en.ttest <-tsum.test(# x = NST
  mean.x=as.numeric(bin.en.NST[1]),
  s.x   =as.numeric(bin.en.NST[2]),n.x=50,
  # y = trans
...
# NST > Deep statistically significant at p<0.008
...
bin.es.NST <- max.bin.es %>% 
  filter(trans.lang=="ES NST") %>% 
  filter(mt.tool=="NST") %>% 
  filter(case=="Cased") %>%
  ungroup() %>%
  select(f1, sd)
...
# T-test
bin.es.ttest <-tsum.test(# x = NST
  mean.x=as.numeric(bin.es.top[1]),
  s.x   =as.numeric(bin.es.top[2]),n.x=50,
  # y = trans
  mean.y=as.numeric(bin.es.NST[1]),
  s.y   =as.numeric(bin.es.NST[2]),n.y=50)

bin.es.ttest
bin.es.top
bin.es.NST

# GT > NST Statistically significant at p<0.000
...
# T-test
quad.ar.ttest <-tsum.test(# x = NST
  mean.x=as.numeric(quad.ar.top[1]),
  s.x   =as.numeric(quad.ar.top[2]),n.x=50,
  # y = trans
  mean.y=as.numeric(quad.ar.NST[1]),
  s.y   =as.numeric(quad.ar.NST[2]),n.y=50)

quad.ar.ttest
quad.ar.top
quad.ar.NST
# Deep > NST Statistically significant at p<0.02
...
# T-test
quad.en.ttest <-tsum.test(# x = NST
  mean.x=as.numeric(quad.en.top[1]),
  s.x   =as.numeric(quad.en.top[2]),n.x=50,
  # y = trans
  mean.y=as.numeric(quad.en.NST[1]),
  s.y   =as.numeric(quad.en.NST[2]),n.y=50)

quad.en.ttest
quad.en.top
quad.en.NST

# Deep > NST statistically significant at p<0.000
...
# T-test
quad.es.ttest <-tsum.test(# x = NST
  mean.x=as.numeric(quad.es.top[1]),
  s.x   =as.numeric(quad.es.top[2]),n.x=50,
  # y = trans
  mean.y=as.numeric(quad.es.NST[1]),
  s.y   =as.numeric(quad.es.NST[2]),n.y=50)

quad.es.ttest
quad.es.top
quad.es.NST

# DeepL > NST Statistically significant at p<0.04
...
binquad.ar.NST <- max.binquad.matconf.ar %>% 
  filter(trans.lang=="AR NST") %>% 
  filter(mt.tool=="NST") %>% 
  filter(case=="Uncased") %>%
  ungroup() %>%
...
# T-test
binquad.ar.ttest <-tsum.test(# x = NST
  mean.x=as.numeric(binquad.ar.top[1]),
  s.x   =as.numeric(binquad.ar.top[2]),n.x=50,
  # y = trans
  mean.y=as.numeric(binquad.ar.NST[1]),
  s.y   =as.numeric(binquad.ar.NST[2]),n.y=50)
...
binquad.en.NST <- max.binquad.matconf.en %>% 
  filter(trans.lang=="EN NST") %>% 
  filter(mt.tool=="NST") %>% 
  filter(case=="Cased") %>%
  ungroup() %>%
...
# T-test
binquad.en.ttest <-tsum.test(# x = NST
  mean.x=as.numeric(binquad.en.top[1]),
  s.x   =as.numeric(binquad.en.top[2]),n.x=50,
  # y = trans
  mean.y=as.numeric(binquad.en.NST[1]),
  s.y   =as.numeric(binquad.en.NST[2]),n.y=50)
...
binquad.es.NST <- max.binquad.matconf.es %>% 
  filter(trans.lang=="ES NST") %>% 
  filter(mt.tool=="NST") %>% 
  filter(case=="Uncased") %>%
  ungroup() %>%
...
# T-test
binquad.es.ttest <-tsum.test(# x = NST
  mean.x=as.numeric(binquad.es.NST[1]),
  s.x   =as.numeric(binquad.es.NST[2]),n.x=50,
  # y = trans
...
binquad.ar.NST <- max.binquad.matcoop.ar %>% 
  filter(trans.lang=="AR NST") %>% 
  filter(mt.tool=="NST") %>% 
  filter(case=="Uncased") %>%
  ungroup() %>%
...
# T-test
binquad.ar.ttest <-tsum.test(# x = NST
  mean.x=as.numeric(binquad.ar.NST[1]),
  s.x   =as.numeric(binquad.ar.NST[2]),n.x=50,
  # y = trans
...
binquad.en.NST <- max.binquad.matcoop.en %>% 
  filter(trans.lang=="EN NST") %>% 
  filter(mt.tool=="NST") %>% 
  filter(case=="Cased") %>%
  ungroup() %>%
...
binquad.es.NST <- max.binquad.matcoop.es %>% 
  filter(trans.lang=="ES NST") %>% 
  filter(mt.tool=="NST") %>% 
  filter(case=="Cased") %>%
  ungroup() %>%
...
binquad.es.ttest <-tsum.test(# x = NST
  ...
  # y = trans
  mean.y=as.numeric(binquad.es.NST[1]),
  s.y   =as.numeric(binquad.es.NST[2]),n.y=50)
...
binquad.ar.NST <- max.binquad.verbconf.ar %>% 
  filter(trans.lang=="AR NST") %>% 
  filter(mt.tool=="NST") %>% 
  filter(case=="Uncased") %>%
  ungroup() %>%
...
binquad.ar.top
binquad.ar.NST
# DeepL > NST Statistically significant at p<0.000
...
binquad.en.NST <- max.binquad.verbconf.en %>% 
  filter(trans.lang=="EN NST") %>% 
  filter(mt.tool=="NST") %>% 
  filter(case=="Cased") %>%
  ungroup() %>%
...
binquad.es.NST <- max.binquad.verbconf.es %>% 
  filter(trans.lang=="ES NST") %>% 
  filter(mt.tool=="NST") %>% 
  filter(case=="Uncased") %>%
  ungroup() %>%
...
binquad.ar.NST <- max.binquad.verbcoop.ar %>% 
  filter(trans.lang=="AR NST") %>% 
  filter(mt.tool=="NST") %>% 
  filter(case=="Cased") %>%
  ungroup() %>%
...
binquad.en.NST <- max.binquad.verbcoop.en %>% 
  filter(trans.lang=="EN NST") %>% 
  filter(mt.tool=="NST") %>% 
  filter(case=="Cased") %>%
  ungroup() %>%
...
# NST > DeepL Statistically significant at p<0.01972
...
binquad.es.NST <- max.binquad.verbcoop.es %>% 
  filter(trans.lang=="ES NST") %>% 
  filter(mt.tool=="NST") %>% 
  filter(case=="Cased") %>%
  ungroup() %>%
