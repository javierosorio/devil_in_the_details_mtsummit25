...
# Download the data 
download.file(
  url = "https://github.com/javierosorio/devil_in_the_details_mtsummit25/raw/main/data/linguistic_analysis/sentence_level/base_measurements/en_counts.csv",
  destfile = "en_counts.csv"
)

data_en <- read.csv('en_counts.csv')
